...
private:
	BOOK(BOOK &b); // Закрыть конструктор копии
};
void prnt(BOOK b){ // Функция копирующая объект
	cout<<"Работает вызываемая функция\n";
	cout<<b.Autor<<endl;

}
void prnt(BOOK *b){// Функция, работает с адресом объекта не создавая новый объект
	cout<<"Работает вызываемая функция\n";
	cout<<b->Autor<<endl;
